...
function draw(rows) {
  ...
  const monthAt = index => { const date = new Date(start); date.setMonth(date.getMonth() + index); return `${date.getFullYear()}年${String(date.getMonth() + 1).padStart(2, '0')}月`; };
  let grid = '';
